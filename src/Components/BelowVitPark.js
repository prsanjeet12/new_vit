  ...
  return (
    <div className="relative h-auto lg:h-80 w-full">
      <div className="ml-4 lg:ml-40  w-full lg:w-[600px] text-[18px] font-arial">
        <h1 className="text-center text-[#2080d1] font-bold text-[22px] mt-5 mb-9">
          Your Gateway to Digital Innovation
        </h1>
        <span className="text-center w-[200px]">
          At VITPARK, we are dedicated to driving digital transformation and
          ...
          unlock endless possibilities for success.
        </span>
        <div></div>
      ...
      <div
        className="hidden lg:block absolute top-1 right-0
